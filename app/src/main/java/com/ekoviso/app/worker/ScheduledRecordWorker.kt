...
class ScheduledRecordWorker @AssistedInject constructor(
    ...
    override suspend fun doWork(): Result {
        ...
        val ffmpegCommand = "-y -reconnect 1 -reconnect_streamed 1 -reconnect_delay_max 10 -i \"${schedule.channelUrl}\" -c copy -t ${schedule.durationMinutes * 60} \"${outputFile.absolutePath}\""
